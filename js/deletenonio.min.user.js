...
const deleteNonio={el:{html:document.documentElement,body:document.body},events(){const hasElement=setInterval(()=>{if(document.querySelectorAll('[id^="layer_gatting"]')[0]){clearInterval(hasElement)
	this.el.html.style='overflow: auto !important';this.el.body.style='overflow: auto !important';document.querySelectorAll('[id^="layer_gatting"]')[0].outerHTML=''}
	if(document.querySelectorAll('.nonioBox')[0]){clearInterval(hasElement)
	this.el.html.style='overflow: auto !important';this.el.body.style='overflow: auto !important';document.querySelectorAll('.nonioBox')[0].outerHTML=''}
	if(document.querySelectorAll('.warning-nonio-overlay')[0]){clearInterval(hasElement)
	this.el.html.style='overflow: auto !important';this.el.body.style='overflow: auto !important';document.querySelectorAll('.warning-nonio-overlay')[0].outerHTML=''}
	if(document.querySelectorAll('.tp-modal')[0]){clearInterval(hasElement)
	this.el.html.style='overflow: auto !important';this.el.body.style='overflow: auto !important';document.querySelectorAll('.tp-modal')[0].outerHTML=''}
