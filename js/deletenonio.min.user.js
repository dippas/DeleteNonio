...
const deleteNonio={el:{html:document.documentElement,body:document.body},events(){this.el.html.style.overflow="auto",this.el.body.style.overflow="auto",document.querySelectorAll("[id^=\"layer_gatting\"]")[0].outerHTML="",document.querySelectorAll(".nonioBox")[0].outerHTML=""},init(){window.onload=()=>{this.events()}}};deleteNonio.init();
