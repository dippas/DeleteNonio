const deleteNonio = {
	el: {
		...
		body: document.body,
		globalmediaGroupUrls: ['dinheirovivo.pt', 'tsf.pt', 'vdigital.pt', 'ojogo.pt', 'jn.pt', 'dn.pt', 'n-tv.pt', 'evasoes.pt', 'menshealth.pt', 'womenshealth.pt', 'noticiasmagazine.pt', 'voltaaomundo.pt', 'delas.pt'],
